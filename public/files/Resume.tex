...
\skill {Frameworks}{React v16+, Flask, PostgreSQL, Flutter, Redux, NodeJS, Express, MongoDB}
...
\vspace{0pt}
\resumeItemListStart
\resumeItemWithoutTitle{Reduced total API calls by 30\%, enhancing app functionality and contributing to business scalability}
...
\resumeItemWithoutTitle{Developed a responsive web app with pixel perfect user interfaces based on Figma designs. Used Client-Server architecture with dynamic theming and drag-and-drop UI, focussing on A11y, ARIA and Semantic HTML. Deployed to AWS EC2 using Docker and ECR with a CI/CD pipeline using Github Actions. Handled security with HTTPS/SSL on the AWS Load Balancer}
\resumeItemListEnd
