...
\resumeItemWithoutTitle{Developed an accessible, responsive Kanban Task Manager using Client-Server architecture with React Hooks and Context API. Deployed to AWS EC2 using Docker and ECR with a CI/CD pipeline using Github Actions. Handled security with HTTPS/SSL on the AWS Load Balancer.}
\resumeItemListEnd
