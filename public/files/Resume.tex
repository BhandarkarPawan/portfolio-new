...
\resumeItemWithoutTitle{Actively containerized and deployed applications utilizing Docker, configured AWS CloudWatch for remote monitoring across 5 unmanned store locations, effectively ensuring streamlined and efficient operations}
\resumeItemWithoutTitle{Streamlined 3 ongoing projects by engineering a Search System using Python, SQL, GraphQL, and React, styled with TailwindCSS, resulting in faster and a more efficient data retrieval}
\resumeItemListEnd
