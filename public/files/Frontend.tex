...
% \resumeItemWithoutTitle{Led the end-to-end development of  a RESTful payment server leveraging Python, Flask, and PostgreSQL for CRUD operations, resulting in the expansion of customer base, contributing to $\sim$¥500K increase in annual revenue.}
