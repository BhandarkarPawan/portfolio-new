...
% \resumeItemWithoutTitle{Led research efforts for BERT with PyTorch to automate support request routing in an apartment intercom system by recognizing named entities and integrating it with the Express.js API Server to provide AI as a Service}
...
% \vspace{3pt}
% \projectHeading{Incident Response}{AWS, Docker, React, Socket.IO, MongoDB, Jenkins, Jira}{https://sa.sem-ir.com/}{Feb 2023 - Present}
% \resumeItemListStart
% \resumeItemWithoutTitle{Developed a communication platform for citizens and first responders during emergencies using Express.js.js, Socket.IO, and Mongoose. Refactored codebase and managed development in a scrum-of-scrums setting. Deployed the app using Docker, Jenkins, and AWS.}
% \resumeItemListEnd
...
% \vspace{3pt}
% \projectHeading {Re:use}{React, Typescript, Node.js, MongoDB, Figma, Jama, Miro}{https://mailchi.mp/6cf20f3d592f/reuse}{Aug 2022 - Dec 2022}
% \resumeItemListStart
