export const SKILLS = [
    ...
    //     level: 4,
    //     content:
    //         "styled-components is a CSS-in-JS library that is mostly inspired by glamorous, written by Max Stoiber, and popularized by Kent C. Dodds. It allows you to write actual CSS code to style your components. It also removes the mapping between components and styles - using components as a low-level styling construct could not be easier!",
    // },
    {
        name: "TailwindCSS",
        level: 4,
