    ...
    <Wrapper>
      <MaxWidthWrapper>
        ...
        <Items>
          ...
          <SlideUp>
            <Item>
              <Image src="images/converge.png" alt="converge-lab"></Image>
              <DotPrimary>
                <DotCore />
              </DotPrimary>
              <Connector />
              <Info>
                ...
                <Description>
                  ...
                  Hardware Engineers to accelerate the design process of
                  hardware circuits and systems
                </Description>
              </Info>
            </Item>
          </SlideUp>
          <SlideUp>
            <Item>
              <Image src="images/tunein.png" alt="tunein-radio"></Image>
              <DotPrimary>
                <DotCore />
              </DotPrimary>
              <Connector />
                ...
                <Bullet>
                  ...
                  <Info>
                    ...
                    <Description>
                      ...
                      including a microservice that handles biometric payments
                      for an unmanned stored and a search system for Kyushu
                      Electric that allowed their employees to manage inspection
